...
final class FetchRequestStoreTests: XCTestCase {
    ...
    func test_tryFetchSuccess_returnsFetchStateSuccess() {
        ...
        XCTAssertEqual(sut.fetchRequestHasError, false, "'fetchRequestError' should remain false in success case.")
    }
    ...
    func test_tryFetchFailure_returnsFetchStateFailure() {
        ...
        XCTAssertEqual(sut.fetchRequestHasError, true, "'fetchRequestError' should be true in failure case.")
    }
