...
struct NetworkClientTests {
    ...
    @Test("When `URLCache` contains a cached response for today, `fetchQuoteOfTheDay` returns the cached response and skips the network")
    ...
    @Test("When server returns non-200 status code, should throw correct error")
    ...
    @Test("When server returns malformed JSON, should throw correct error")
